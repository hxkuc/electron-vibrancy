...
app.on('ready', function () {
  ...
  mainWindow.on('ready-to-show',function() {
    ...
    // electronVibrancy.AddView(mainWindow, { Width: 300,Height:300,X:0,Y:0,ResizeMask:2,Material:3 })

    // non-resizing vibrant view at {0,0} with size {300,300} with Material 0
    // electronVibrancy.AddView(mainWindow, { Width: 300,Height:300,X:0,Y:0,ResizeMask:3,Material:1 })
    ...
    var viewId1 = electronVibrancy.AddView(mainWindow, { Width: 300,Height:300,X:0,Y:0,ResizeMask:3,Material:1 })
